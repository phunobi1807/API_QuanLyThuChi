...
import { createUser, deleteUsers, getSendMail, getUserByPhone, getUsers, Login, Logout, updateUsers } from "../controllers/Users";
...
routerUsers.post("/resetPassword", getSendMail);
